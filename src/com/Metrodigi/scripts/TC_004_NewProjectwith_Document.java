...
public class TC_004_NewProjectwith_Document extends DriverTestCase {
	 ...
	 *          Click on Add New Project button Step 6: Add Project Details Step
	 *          7: Upload Document file Step 8: Save Project Step 9: Verify the
	 *          created Collection and Project
	 * @param none
	 * @return None.
	 * @throws Exception
	 * @exception None.
