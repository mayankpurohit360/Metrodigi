/*==============================================================================================================================
E:\AutomationWorkspace\Metrodigi\Attachments\Audio.mp3

 E:\AutomationWorkspace\Metrodigi\Attachments\Tiger.jpg
 
 E:\AutomationWorkspace\Metrodigi\Attachments\video.mp4
 E:\AutomationWorkspace\Metrodigi\Attachments\Tiger.jpg
...
public class TC_006_NewProjectwith_Mediafiles extends DriverTestCase {
	 ...
	 *          Step 2: Login into the application Step 3: Click on New Project
	 *          button to add New Project Step 4: Add Collection Details Step 5:
	 *          Add New Project Step 6: Upload Media files like image, audio,
	 *          video Step 7: Save Project Step 8: Verify the created Collection
	 *          and Project
	 * @param none
	 * @return None.
	 * @throws Exception
	...
	public void logintest() throws Exception {
		...
		Reporter.log("Added " + projectname + " Project in collection "
				+ collectionName, true);
